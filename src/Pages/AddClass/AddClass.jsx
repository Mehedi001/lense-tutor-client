    ...
    return (
        ...
        <div>
            ...
            <Parallax
                ...
                strength={-400}
            >
                <div style={{background: " linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.7))"}} className=' flex flex-col justify-center items-center py-36 lg:py-48'>



                    <div className="my-4 text-center">
                        <h1 className="text-3xl font-semibold text-[#c58f63] underline">Add Courses</h1>
                    ...
                    <div className="section_form">
                        <form onSubmit={handleAddClass} id="consultation-form" className="feed-form">
                            ...
                            <input className='bg-gray-600/30 text-gray-300 focus:bg-white/5 hidden' value={user?.email} required placeholder="email" name='email' type="email" />
