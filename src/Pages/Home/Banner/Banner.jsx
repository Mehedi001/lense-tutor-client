        ...
        <div className="bg-black">
            ...
            >
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/1.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Best Photography <span className="text-yellow-500">Tutor !!!</span> </h1>
                ...
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/2.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Qualified and <br /> Experienced <span className="text-yellow-500"> Instructors !!!</span> </h1>
                ...
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/3.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Hands-on Practical <span className="text-yellow-500">Sessions !!!</span> </h1>
                ...
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/4.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Guest Lectures and <span className="text-yellow-500">Workshops !!!</span> </h1>
                ...
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/5.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Online Learning <span className="text-yellow-500">Resources !!!</span> </h1>
                ...
                <SwiperSlide className="relative">
                    <img className="opacity-50 " src="/public/banner/6.jpg" alt="" />
                    <div className="absolute top-1/3 lg:top-[50%] text-center left-2 lg:left-[2%]">
                        <h1 className=" text-3xl lg:text-6xl font-bold text-white ">Exhibitions and Networking <span className="text-yellow-500">Opportunities !!!</span> </h1>
