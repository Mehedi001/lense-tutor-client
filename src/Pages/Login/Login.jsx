        ...
        <div style={{ background: " linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://i.ibb.co/F7XT2KF/login-background.jpg')", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }} className='flex justify-center items-center h-screen '>
            ...
            <form onSubmit={handleLogin} className="form_container">
                ...
                <div className="title_container">
                    ...
                    <span className="subtitle">Don't have account ? just create an account and enjoy the experience. <Link to="/register" className='text-green-500'>Register</Link> </span>
                </div>
                <br />
                <div className="input_container">
                    ...
                    <input placeholder="Enter your email" title="Enter your email" name="email" type="text" className="input_field" id="email_field" />
                </div>
                <div className="input_container">
                    ...
                    <input placeholder="Password" title="Enter your password" name="password" type="password" className="input_field" id="password_field" />
                </div>
                <input title="Sign In" type="submit" className="sign-in_btn" value="Sign In" />
                ...
                <button onClick={handleGoogleSignIn} title="Sign In" type="submit" className="sign-in_ggl">
